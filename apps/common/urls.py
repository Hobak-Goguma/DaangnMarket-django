...
urlpatterns = [
	...
	path('member/id/<int:id_member>/', views.MemberDetail.as_view(), name='member_detail'),
	path('member/info/', views.member_info, name='member_touch'),
	path('member/addr/id/<int:id_member>/', views.member_addr, name='member_addr'),
	...
	path('wishlist/<int:id_member>/', views.wishlist_detail, name='wishlist_detail'),
	path('product/selling/<int:id_member>/', views.selling_product_list, name='selling_product_list'),
